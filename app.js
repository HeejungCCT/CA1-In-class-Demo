...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('LotusMassage.xml', 'utf8'); //We are reading in the XML file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('LotusMassage.xml', function(err, result) {
      ...
      result.massagemenu.section[obj.sec_n].type.push({'item': obj.item, 'session': obj.session, 'price': obj.price, }); //If your XML elements are differet, this is where you have to change to your own element names
